...
import { collection, query, where, getDocs, orderBy, limit, setDoc, doc, or } from "firebase/firestore";
import { db } from '../../firebase/index'
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons';
import { useSelector } from 'react-redux';
const listTab = ['Bán chạy','Tất cả', 'Thịt,cá,trứng,hải sản', 'Rau,củ,quả,trái cây', 'Dầu ăn,nước chấm,gia vị', 'Nước ngọt,bia,sữa', 'Gạo,bột,đồ khô', 'Kem,thực phẩm đông lạnh'];
function TapRecipeStore(props) {
  const { navigation, mach } = props
